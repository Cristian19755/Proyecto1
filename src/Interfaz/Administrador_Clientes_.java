 ...
 * @author lgtjo
 */
public class Administrador_Clientes_ extends javax.swing.JFrame {

    private String[] Dpi = {"Dpi","Nombre","Nit","Correo","Genero"};
    private String[][] valores;
    private JFrame ventana;
    private Controlador controlador;
    /**
     * Creates new form Administrador_Clientes_
     */
    public Administrador_Clientes_() {
        initComponents();
    }
    
    public Administrador_Clientes_(JFrame ventana, Controlador controlador){
    ...
    private void initComponents() {
        ...
        JButtonCarga.setText("Cargar cliente");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(JDpi, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                                    .addComponent(JNit, javax.swing.GroupLayout.Alignment.LEADING))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(JCorreo, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
                                        .addGap(29, 29, 29)
    ...
    private void JButton_CargaMasivaActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        try{
            String url = this.JRuta.getText();
            this.controlador.Cargar_Json_Clientes(url);
        }catch(Exception e){
            JOptionPane.showMessageDialog(this,"Complete todos los campos");
        }
        
        String [][] matriz = this.controlador.matriz_Clientes();
        DefaultTableModel modelo = new DefaultTableModel(matriz,this.Dpi);
        this.jTable1.setModel(modelo);
    }                                                   

    private void JButtonCargaActionPerformed(java.awt.event.ActionEvent evt) {                                             
        
        try{
            String Dpi = this.JDpi.getText();
            String Nit = this.JNit.getText();
            int Nombre = Integer.parseInt(this.JNombre.getText());
            int Correo = Integer.parseInt(this.JCorreo.getText());
            String genero = String.valueOf(this.jComboBox1.getSelectedItem());
            this.controlador.Cargar_Clientes(Dpi, Nit, genero, Nombre, Correo);
        }catch(Exception e){
            JOptionPane.showMessageDialog(this,"Complete todos los campos");
        }
        String [][] matriz = this.controlador.matriz_Clientes();
    ...
    private void JDpiActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
    }                                       

    private void JGraficarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        JFreeChart graficar = this.controlador.Graficar_Clientes();
        ChartPanel panel = new ChartPanel(graficar);
        JFrame ventana = new JFrame("Genero_Clientes");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try {
            ...
            file.write(this.controlador.info_Clientes());
            file.close();
        } catch (IOException ex) {
            Logger.getLogger(Administrador_Clientes_.class.getName()).log(Level.SEVERE, null, ex);
        }
    }                                        
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String Dpi = JOptionPane.showInputDialog("Ingrese el nuevo Dpi");
        String Nit = JOptionPane.showInputDialog("Ingrese el nuevo Nit");
        ...
        String Nombre = JOptionPane.showInputDialog("Ingrese la nueva Nombre");
        this.controlador.modificar(this.jTable1.getSelectedRow(), Dpi, Nit, genero,Integer.parseInt(Nombre),Integer.parseInt(Correo));
        String [][] matriz = this.controlador.matriz_Clientes();
        DefaultTableModel modelo = new DefaultTableModel(matriz,this.Dpi);
        this.jTable1.setModel(modelo);
    }                                        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Administrador_Clientes_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Administrador_Clientes_().setVisible(true);
            }
        });
    }
